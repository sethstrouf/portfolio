...
const CardRight = ({
  ...
  const renderSummary = () => {
    if (optUrl) {
      ...
      return (
        <div className="col-start-1 col-span-8 row-span-2 flex justify-center items-center">
          <p>{summary}</p>
        </div>
      );
    }
  ...
  return (
    <div
      className="h-48 lg:h-60 xl:h-72 w-10/12 leading-none
                    mx-auto grid grid-cols-12 grid-rows-6
                  bg-white rounded-md overflow-hidden shadow
                    hover:shadow-lg scale-hover"
    >
      <div
        className="col-start-1 col-span-8 row-span-2 text-xl flex justify-center items-center 
      ...
      <div
        className="col-start-1 col-span-8 row-span-1 px-0.5 
      ...
      <div
        className="col-start-1 col-span-4 row-span-1 flex justify-center items-center
                      hover:bg-green-100 cursor-pointer
                       text-green-700"
      >
        <p>
          <a href={pageUrl} className="font-bold focused">
            Go to Site
          </a>
        </p>
      </div>
      ...
      <div
        className="col-start-5 col-span-4 row-span-1 flex justify-center items-center
                      hover:bg-green-100 cursor-pointer text-green-700"
      >
        <p>
          <a href={codeUrl} className="font-bold focused">
            Go to Code
          </a>
        </p>
      </div>
