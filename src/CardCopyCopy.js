...
const CardCopyCopy = ({ image, alt, summary, tech, pageUrl, codeUrl, optUrl, children} ) => {
  ...
  const renderSummary = () => {
    if (optUrl) {
      ...
      return <div className="col-span-8 row-span-2 flex justify-center items-center">
        <p>
          {summary}
        </p>
      </div>
