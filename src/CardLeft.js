...
const CardLeft = ({
  ...
  return (
    ...
    >
      ...
      <div
        className="col-span-8 row-span-2 text-xl flex justify-center items-center 
      ...
      <div
        className="col-span-8 row-span-1 px-0.5 
      ...
      <div
        className="col-span-4 row-span-1  flex justify-center items-center
